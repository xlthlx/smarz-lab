...
global $post;
$text_more = esc_html__( 'Keep reading: ', 'smarz-lab' );
?>
<article class="tease tease-<?php echo $post->post_type; ?>" id="tease-<?php echo $post->ID; ?>">
	<div class="p-4 p-md-5 bg-light rounded-0 mb-4">
		...
		<p class="pr-4"><?php echo sl_get_excerpt(); ?>
			<a title="<?php echo $text_more . get_the_title(); ?>" href="<?php echo get_the_permalink(); ?>"><?php echo esc_html__( 'Read more...', 'smarz-lab' ); ?></a>
		</p>
		<hr/>
